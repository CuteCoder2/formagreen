<?php
require_once('../function/get_members_green.php');
...
.delete,.btn{
    background-color: #e00f0f;
     ...
     <form action="../function/member_update_area.php" method="POST" name="edit" id="edit">
     <br>
     <br>
     <br>
     <br>
...
<form action="../function/delete_member_area.php" method="POST" name="delete" id="delete_area">
<br>
     <br>
     <br>
     <br>
...
<table id ="table">
    <tr id="header">
        ...
        <?php
        foreach($fet_all_areas_member as $row){
            echo'
        <tr class="tr">
